...
require_once "controlador/registrar_estatus.php";
session_start();
...
<html lang="en">
    ...
    <script type="text/javascript">
        function confirmRegistrar(){
            var respuesta = confirm("Se resgistrará el estatus, ¿Estás seguro?");
        ...
        <section id="ausoporte2">
                            ...
                            <table class="table mt-3" id="mitabla">
                                ...
                                <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                <th style="font-weight: normal;"><?php  echo $row["id_estatus"]?></th>
                                                <th style="font-weight: normal;"><?php  echo $row["estatus"]?></th>   
                                                <th style="font-weight: normal;"><a href="update_estatus.php?id=<?php echo $row['id_estatus'] ?>"><i style="place-items: center; justify-content: center; display:grid;" class="bi bi-pencil-fill"></i></a></th>
                                                <th style="font-weight: normal;"><a onclick="return confirmDelete()" href="controlador/eliminar_estatus.php?id=<?php echo $row['id_estatus'] ?>"><i style="place-items: center; justify-content: center; display:grid;" class="bi bi-trash3-fill"></i></a></th>                                        
                                            </tr>
                                        <?php 
                                            }
                                        ?>
