                        ...
                        <div class="contacts">
                                    ...
                                    <div>
                                        ...
                                        $ruta = "evidencias/".$repor;
                                            ...
                                            while ($file = readdir($filehandle)) {
                                                    if ($file != "." && $file != "..") {
                                                        $nx = date("Y-m-d H:i:s", filectime($ruta."/".$file)); //aqui se pone la ruta entre putnos porque es php y abajo directo por ser html
                                                            echo "      <p>
                                                                            <label  style='margin-top: -25px;'><i class='bi bi-eye-fill'></i><a href='$ruta/$file'> $file</a> - $nx</label> 
                                                                        </p>
                            ...
                            <p class="full-width">
                                <?php 
                                    ...
                                    $sql = "SELECT * FROM cargos WHERE id_soporte = $soporte and id_reporte = $repor";
                            ...
                            <form action="controlador/cargos.php" method="POST">
                            <input type="hidden" name="id" value="<?php echo $repor;?> ">
                                    <label></label><br>
                                    <p>
                                        <label>Fecha</label><br>
                                        <input type="hidden" value="<?php echo $soporte ?>" name="soporte">
                                        <input style="color: black;" readonly type="text" id="fecha" name="fecha" value="<?php echo date("d-m-Y");?>" required>
                                    </p>
                                    <p>
                                        <label>Monto</label><br>
                                        <input style="color: black;" type="number" step="any" id="monto" name="monto" required>
                                    </p>
                                    
                                    <p class="full-width">
                                        <label>Concepto</label><br>
                                        <textarea style="color: black;" type="text" id="concepto" name="concepto" value="" required></textarea>
                                    </p>
                                   
                                    
                                    <p class="full-width">
                                        <div class="full-width" id=btn_si>
                                            <input name="submit" type="submit" class="btn btn-primary" value="Actualizar">
                                        </div>
                                    </p>
                            </form>
                        </div>
                        <div class="form">
                            <form enctype="multipart/form-data" name="form" action="controlador/update_reporte.php" method="POST" >
                                <input type="hidden" name="id" value="<?php echo $repor;?> ">
                                    ...
                                    <p>
                                        <label>&Aacuterea: <?php echo $dato6?></label>
                                    ...
                                    <p>
                                        <label>Tel&eacutefono: <?php echo $dato3?></label>
                                        
                                    </p>
                                    <p>
                                        <label>Categor&iacutea: <?php echo $dato5?></label>
                                        
                                    </p>
                                    <p>
                                        <label>Fecha de Creaci&oacuten: <?php echo $dato9?></label>
                                        
                                    </p>
                                    <p >
                                        <label>Ticket/Reporte: <?php echo $dato7?></label>
                                    ...
                                    <select class="con_estilos_reporte" id="auxiliar" name="auxiliar">';
                                                            <option value="<?php echo $dato15 ?>"><?php echo $dato15 ?></option>"";
                                                                <?php
                                                                foreach ($r_rol as $id => $rol)
                                                                {
                                                                    echo '<option value="'.$rol['usuario'].'">'.$rol['usuario'].'</option>';
                                                                }
                                                                ?>
                                    </select>
                                    </p>
                                    <!-- <p>
                                        ...
                                        <input type="text" id="equipo" name="equipo" value="<?php echo $dato11?>" ></input>
                                    </p> -->
                                    <!-- <p >
                                        <label>Serie</label><br>
                                        <input  type="text" id="serie" name="serie" value="<?php echo $dato12?>" ></input>
                                    </p><br> --><br>
                                    <p class="full-width">
                                        <label style="text-transform: uppercase">Ticket/Reporte</label><br>
                                        <input readonly type="text" id="" name="" value="<?php echo $dato7?>" required></input>
                                    </p><br>
                                    <p class="full-width">
                                        <label>Observaciones</label><br>
                                        <textarea style="height: 200px;" type="text" id="observaciones" name="observaciones" required><?php echo $dato13?></textarea>
                                    </p>
                                    
                                    <p class="full-width">
                                        <label>Soluci&oacuten</label><br>
                                        <textarea style="height: 200px;" type="text" id="solucion" name="solucion" required><?php echo $dato8?></textarea>
                                    </p><br>
                                    <p class="full-width">
                                    ...
                                    <p class="full-width">
                                        <div id=btn_si>
                                            <input onclick= "return confirmUpdate()" name="submit" type="submit" class="btn btn-primary" value="Actualizar">
                                        </div>
                                        <div id=btn_no>
