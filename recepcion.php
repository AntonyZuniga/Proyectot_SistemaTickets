                ...
                <div class="conttabla">
                    ...
                    <table class="table mt-3" id="mitabla">
                        ...
                        <tr>
                            ...
                            <th>Usuario</th>
                            <th>Ticket/Reporte</th>
                            <th style="visibility: hidden; display: none;">Id Soporte</th>
                        ...
                        <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <th style="width: 100px; font-weight: normal; visibility: hidden; display: none;"> <?php echo $row["id_usuario"]?></th>
                                        <th style="width: 100px; font-weight: normal;"> <?php echo $row["usuario"]?></th>  
                                        <th style="font-weight: normal;"><a href="asignar.php?id=<?php echo $row['id_reporte'] ?>">Asignar</a></th>               
                                    </tr>
                                <?php 
                                    }}mysqli_close($link);
                                ?>
