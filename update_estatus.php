...
if(!$auth){
    ...
    $sql = "SELECT * FROM estatus where id_estatus=$dato1";
                        ...
                        <div class="wrapper"><br>
                            ...
                            <form action="controlador/update_estatus.php" method="POST" >
                                ...
                                <div class="form-group">
                                        ...
                                        <input id="up_cate" type="text" id="estatus" name="estatus" value="<?php echo $dato2?>" required><br>
                                    ...
                                    <div id=btn_no>
                                        <input onclick="location.href='abc_estatus.php'" type="button" class="btn btn-danger" value="Volver">
                                    </div>
                                    <br>
                            </form>
                        </div>   
