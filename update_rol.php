...
if(!$auth){
    ...
    $sql = "SELECT * FROM rol where id_rol=$dato1";
                            ...
                            <h2>Modificar Rol</h2>
                                <form action="controlador/update_rol.php" method="POST" >
                                    ...
                                    <div class="form-group">
                                            <label>Rol</label><br>
                                            <input type="text" id="rol" name="rol" value="<?php echo $dato2?>" required><br>
                                        ...
                                        <div id=btn_no>
                                            <input onclick="location.href='abc_roles.php'" type="button" class="btn btn-danger" value="Volver">
                                        </div>
                                        <br>
                                </form>
                        </div>   
