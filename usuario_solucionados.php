        ...
        <body><br><br><br><br>
            ...
            <div class="container">
                <ul class="nav nav-tabs">
                    <li><a href="usuario.php">Reportados</a></li>
                    <li class="active"><a href="#">Solucionados</a></li>
                </ul><br><br>
                <div class="conttabla">
                    ...
                    <table class="table mt-3" id="mitabla">
                        ...
                        <tr>
                            ...
                            <th>id_reporte</th>
                            <th>Usuario_reporte</th>
                            <th>Estatus</th>
                            <th>Usuario</th>
                            <th>Auxiliar</th>
                            <th>Fecha</th>
                            <th style="visibility: hidden; display: none;">Fecha ter</th>
                        ...
                        <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <th style="font-weight: normal;"><?php  echo $row["estatus"]?> <a href="ver_usuario.php?id=<?php echo $row["id_reporte"]?>"><i style="place-items: right; justify-content: right; padding-left: 10px;" class="bi bi-eye-fill"></i></a> </th>
                                        <th style="width: 100px; font-weight: normal;"> <?php echo $row["usuario"]?></th>
                                        <th style="width: 100px; font-weight: normal;"> <?php echo $row["auxiliar"]?></th>
                                        <th style="width: 100px; font-weight: normal;"> <?php echo $row["fechacrea"]?></th>  
                                        <th style="width: 100px; font-weight: normal; visibility: hidden; display: none;"> <?php echo $row["fechater"]?></th>  
