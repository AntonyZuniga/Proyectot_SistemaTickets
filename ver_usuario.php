                        ...
                        <div class="form">
                            <form enctype="multipart/form-data" name="form" action="controlador/update_reporte.php" method="POST" >
                                <input type="hidden" name="id" value="<?php echo $repor;?> ">
                                    ...
                                    <p >
                                        <label>Problema: <?php echo $dato7?></label><br>
                                    ...
                                    <p>
                                        ...
                                        <input readonly type="text" id="patrimonio" name="patrimonio" value="<?php echo $dato10?>"></input>
                                    </p>
                                    <p>
                                        <label>Tipo de Equipo</label><br>
                                        <input readonly type="text" id="equipo" name="equipo" value="<?php echo $dato11?>"></input>
                                    </p>
                                    
                                    <p >
                                        <label>Serie</label><br>
                                        <input readonly type="text" id="serie" name="serie" value="<?php echo $dato12?>"></input>
                                    </p><br>
                                    <p class="full-width">
                                        <label style="text-transform: uppercase">Problema</label><br>
                                        <input readonly type="text" id="solucion" name="solucion" value="<?php echo $dato7?>" required></input>
                                    </p><br>
                                    <p class="full-width">
                                        <label>Observaciones del Equipo</label><br>
                                        <textarea style="height: 300px;" readonly type="text" id="observaciones" name="observaciones" value="" required><?php echo $dato13?></textarea>
                                    </p>
                                    <p class="full-width">
                                        <label>Soluci&oacuten</label><br>
                                        <input readonly type="text" id="solucion" name="solucion" value="<?php echo $dato8?>" required></input>
                                    </p><br>
                                    <p class="full-width">
                                    ...
                                    <p class="full-width">
                                            ...
                                            <input onclick="location.href='usuario.php'" type="button" class="btn btn-danger" value="Volver">
